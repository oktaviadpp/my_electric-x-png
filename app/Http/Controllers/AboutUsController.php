...
class AboutUsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //FLASH MASSAGE
        return redirect('/aboutus')->with('message', 'Data Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, AboutUs $about)
    {
        ...
        // FLASH MESSAGE
        return redirect('/aboutus')->with('message', 'Data Berhasil Diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        // FLASH MESSAGE
        return redirect('/aboutus')->with('message', 'Data Berhasil Dihapus');
    }
}

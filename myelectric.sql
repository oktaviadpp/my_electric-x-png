...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Sep 2021 pada 16.09
...
--
-- Struktur dari tabel `artikelkats`
--
...
--
-- Dumping data untuk tabel `artikelkats`
--
...
--
-- Struktur dari tabel `produkkats`
--
...
--
-- Dumping data untuk tabel `produkkats`
--
...
(13, 'Rahma Nur Aprilia', 'rahma@gmail.com', 'admin', NULL, '$2y$10$gAceR0I6QPnGsZOPQSpSruxUpwv0hWAxCE2NbCN6nireAkqUpv/jC', NULL, '2021-08-26 20:24:43', '2021-08-26 20:24:43'),
(14, 'okta', 'okta@gmail.com', 'user', NULL, '$2y$10$iHA844uoOsmAt6mHwJCFpeyQHio.901MhFjfCroWznskkoTD723qO', NULL, '2021-09-18 21:34:37', '2021-09-18 21:34:37');
...
--
-- Indeks untuk tabel `artikelkats`
--
...
--
-- AUTO_INCREMENT untuk tabel `artikelkats`
--
ALTER TABLE `artikelkats`
...
--
-- AUTO_INCREMENT untuk tabel `produkkats`
--
ALTER TABLE `produkkats`

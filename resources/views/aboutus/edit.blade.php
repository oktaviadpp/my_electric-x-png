...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            {{-- <form action="{{ route('about_us.update', ['about'=>$about]) }}" method="POST" enctype="multipart/form-data"> --}}
            <form action="{{ url('about_us/'. $about->id) }}" method="POST" enctype="multipart/form-data">
              @method('POST')
              @csrf
            <div class="card">

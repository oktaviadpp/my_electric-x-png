  ...
  <main>
      <div class="container-fluid px-4">
          ...
          <div class="card">
            ...
            <br>
            <form action="{{route('galeri.index') }}" method="GET" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" >
              <div class="input-group">
                <a href =" {{route('galeri.create')}} " class="btn btn-primary" id="btnNavbarSearch" type="button"><i class="fas fa-plus"></i></a>  

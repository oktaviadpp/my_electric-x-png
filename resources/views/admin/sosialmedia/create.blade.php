  ...
  <main>
      <div class="container-fluid px-4">
          ...
          <div class="card">
            ...
            @endif
            <div class="card-body">
                                                            <form action="{{ route('sosialmedia.store') }}" method="POST" enctype="multipart/form-data">

                                                                @csrf

                                                                <div class="form-group">
                                                                    <label class="font-weight-bold">JENIS SOSIAL MEDIA</label>
                                                                    <input type="text" class="form-control @error('medsos') is-invalid @enderror" name="medsos" value="{{ old('medsos') }}" placeholder="Masukkan Jenis Sosmed">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('icon') is-invalid @enderror" name="icon" value="{{ old('icon') }}" placeholder="Masukkan Icon Sosmed">

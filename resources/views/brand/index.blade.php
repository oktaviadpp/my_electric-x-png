  ...
  <main>
      <div class="container-fluid px-4">
          ...
          <div class="card">
            ...
            <br>
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="get" action="{{ route('brand.index') }}">
              <div class="input-group">
                <a href =" {{ route('brand.create') }} " class="btn btn-primary" id="btnNavbarSearch" type="button"><i class="fas fa-plus"></i></a>  
                      ...
                      {{-- firstItem digunakan untuk mengurutkan nomor --}}
                        ...
                        <td>
                          <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('brand.destroy', $b->id) }}" method="POST">
                            <a href="{{ route('brand.edit', $b->id ) }}" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                            @csrf
                            @method('DELETE')

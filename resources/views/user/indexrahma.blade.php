...
<head>
    ...
    <link href="/css/user2/css/styles.css" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="/css/user2/assets/img/ponorogo-remove.png" style="height: 50px;" alt="..." /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('index') }}">myElectric</a></li>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                ...
                @foreach ($sosialmedia as $sosialmedia)
                <div class="col-lg-1 my-1 my-lg-0">
                    <a class="btn btn-dark btn-social" href="{{ $sosialmedia->link }}"><i class="{{ $sosialmedia->icon }}"></i></a>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <!-- Core theme JS-->
    <script src="/css/user2/js/scripts.js"></script>
    <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
    <!-- * *                               SB Forms JS                               * *-->
